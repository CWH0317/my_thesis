# -*- coding: utf-8 -*-
"""TF_UNet3Plus_UsingImageDataGenerator.ipynb
...
csv_path = "fit_log/data_smalltest.csv"
checkpoint_path = "fit_log/load_from_disk_checkpoint_model_smalltest.ckpt"
...
model.save('UNet3Plus_load_from_disk_smalltest.hdf5')
...
#print(loss)
#print(epochs)
#acc = history.history['unet3plus_output_final_activation_dice_metric']
#acc = history.history['accuracy']
#val_acc = history.history['val_unet3plus_output_final_activation_dice_metric']
...
model = tf.keras.models.load_model('UNet3Plus_load_from_disk_test.hdf5', compile=False)
