# -*- coding: utf-8 -*-
"""Data3_TF_UNet3Plus_UsingImageDataGenerator.ipynb
...
image_generator = image_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/train_images/", 
                                                           target_size=(576, 768),
                                                           seed=seed, 
...
mask_generator = mask_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/train_masks/", 
                                                         target_size=(576, 768),
                                                         seed=seed, 
                                                         batch_size=batch_size,
...
valid_img_generator = image_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/val_images/", 
                                                               target_size=(576, 768),
                                                               seed=seed, 
                                                               batch_size=batch_size, 
                                                               class_mode=None) #Default batch size 32, if not specified here
valid_mask_generator = mask_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/val_masks/", 
                                                               target_size=(576, 768),
                                                               seed=seed, 
                                                               batch_size=batch_size, 
                                                               color_mode = 'grayscale',   #Read masks in grayscale
...
num_train_imgs = len(os.listdir('C:/Users/Impro/Desktop/cwh/Data3/train_images/train/'))

steps_per_epoch = num_train_imgs //batch_size
epochs = 100

csv_path = "C:/Users/Impro/Desktop/cwh/fit_log/Data3_checkpoint_data.csv"
checkpoint_path = "C:/Users/Impro/Desktop/cwh/fit_log/load_from_disk_Data3_checkpoint_model.ckpt"
...
model.save('C:/Users/Impro/Desktop/cwh/Data3_UNet3Plus_load_from_disk.hdf5')
...
model = tf.keras.models.load_model('C:/Users/Impro/Desktop/cwh/Data3_UNet3Plus_load_from_disk.hdf5', compile=False)

test_img_generator = image_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/test_images/",
                                target_size=(576, 768), 
                                seed=seed, 
                                batch_size=4, 
                                class_mode=None) #Default batch size 32, if not specified here

test_mask_generator = mask_data_generator.flow_from_directory("C:/Users/Impro/Desktop/cwh/Data3/test_masks/",
                                target_size=(576, 768), 
                                seed=seed, 
                                batch_size=4, 
                                color_mode = 'grayscale',   #Read masks in grayscale
